...
<div id="hero-about">
  ...
  <div id="content-about">
    ...
    <div class="row1">
        <div class="info-item-about info-item-bg"><span class="game-gen-info">Всяка петък вечер група от супер-cool програмисти се събират за да играят любимата си бордова игра - "IT Village". Те толкова са уморени от кодиране през седмицата, че непрекъснато забравят правилата на играта. Също така им е много трудно да работят с хартия и да хвърлят зарчета и взимат едно много важно решение - играта трябва да бъда развита и превърната в компютърна игра.</span></div>
          <div class="space"></div>
